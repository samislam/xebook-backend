...
>({
  ...
  allowedSelect: ['id', 'debtorUserId', 'creditorUserId', 'currency', 'amount', 'createdAt', 'updatedAt'],
  defaultSelect: ['id', 'debtorUserId', 'creditorUserId', 'currency', 'amount', 'createdAt', 'updatedAt'],
  enforcedSelect: ['id'],
